...
methodDraw.addExtension("view_grid", function(s) {
    if (!document.getElementById("canvasGrid")) {
        ...
        //cflorioluis - crear caras de la pieza
        var gridPattern1 = svgdoc.createElementNS(svgns, "pattern");
        assignAttributes(gridPattern1, {
            'id': 'gridpattern1',
        ...
        var gridimg1 = svgdoc.createElementNS(svgns, "image");
        assignAttributes(gridimg1, {
            'x': 0,
            'y': 0,
            'width': 100,
            'height': 100
        });
        gridPattern1.appendChild(gridimg1);
        $('#svgroot defs')[1].append(gridPattern1);
