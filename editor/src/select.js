...
(function() {
    ...
    svgedit.select.SelectorManager.prototype.initGroup = function() {
        ...
        for (var dir in this.rotateGrips) {
            //cflorioluis - quitar icono de rotacion de los cajeados
            //console.log(svgcanvas.getElem(getId()))
        ...
        //if ($("#canvasBackground_1").length) return;
    ...
    svgedit.select.SelectorManager.prototype.releaseSelector = function(
        ...
        for (var i = 0; i < N; ++i) {
            if (this.selectors[i] && this.selectors[i] == sel) {
                ...
                //console.log(this.selectorMap[elem.id]);
